...
<div class="p-4 sm:ml-64 mt-14">
    ...
    <div class="p-4 bg-white w-full">
        ...
        <!-- <button data-modal-target="edit_modal" data-modal-toggle="edit_modal">coba</button> -->
    </div>
</div>
<script>
    $(function() {
        ...
        $(document).on('click', '.edit_button', function(e) {
            e.preventDefault();
            editModal.show()
            //this technically works to open modal, but its bad
            let id = $(this).attr('id');
            $.ajax({
                url: '/edit_user',
                method: 'get',
        ...
        function initializeEditModal() {
            ...
            const $targetEl = document.getElementById('edit_modal');
            ...
            editModal = new Modal($targetEl, options);
        }
    });
</script>
@endsection
